...
This is a repository for playing around with various code ideas.

_Disclaimer_: Much of the code in this repository is created with AI. Exercise caution when trusting the validity of code and algoriths.

## HTML Dashboards

LLM Models appear to be excel at creating impressive single-file html dashboards. These can be extremely useful for doing simple tasks.
